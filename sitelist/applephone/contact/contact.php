...
<?php
    ...
    $to = "nurdaakz@gmail.com"; // Replace xxxx@xxxx.com with your email address (mandatory!) 
    $subject = "Новая заявка!"; // Choose a custom subject (not mandatory)

    $body = "У вас новая заявка.\n\nИмя: " . $name . "\n" . "Телефон: " . $phone;

    $from = "shop.engroup.kz"; // Replace "Beetle Template" with your site name (not mandatory)   
    $headers = "From:" . $from . "\r\n";
    // $headers .= "Reply-To: " .  . "\r\n";
